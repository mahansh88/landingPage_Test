<template>
    <header class="fixed top-0 z-40 w-screen flex flex-row-reverse justify-between transition-all duration-500 rounded-b-3xl items-center py-1 md:py-6 tracking-tighter px-12 md:px-10 xl:px-20 bg-black/30 text-white">
        ...
        <div class="md:mr-20 flex flex-col items-center p-1 space-y-1">
            <div class="flex flex-row items-center gap-x-1">
                ...
                <img src="/src/assets/images/Header/vecteezy_metallic-style-logo_33659577.png" class="w-12 md:w-12 lg:w-14 xl:w-16 md:bg-cover" alt="">
            </div>
